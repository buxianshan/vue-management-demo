...
- [x] 打开首页时侧边栏首页选项应该直接高亮

  解决方法：设置el-menu的default-active属性绑定一个变量activeIndex，全局通过修改这个变量来决定激活哪个item

- [x] 点击面包屑下面的Tag时，侧边栏也应该跟着联动

  解决方法：点击面包屑直接是触发路由to，在router.beforeEach里根据to.path来修改activeIndex
